...
$('.work.html').click(function(event) {
...
function ColorPallet() {
    ...
    $("ul.pattern .color1").click(function () {
        return $("#option-color").attr("href", "purpule.css")
    });
    $("ul.pattern .color2").click(function () {
        return $("#option-color").attr( "href","orange.css")
    });
    $("ul.pattern .color3").click(function () {
        return $("#option-color").attr("href", "blue-color.css")
    });
    $("ul.pattern .color4").click(function () {
        return $("#option-color").attr("href", "green.css")
    });
    $("ul.pattern .color5").click(function () {
        return $("#option-color").attr("href", "green-blue.css")
    });
    $("ul.pattern .color6").click(function () {
        return $("#option-color").attr("href", "pink-color.css")
    });
...
function  menuToggler() {
    ...
    $menuToggler.click(function () {
        $(this).toggleClass('open').find('i').toggleClass('fa fa-bars fa fa-window-close ');
